...
async function runCompletion(message) {
    ...
    try {
        if (history.includes("rs3") || history.includes("agility") || history.includes("cooking") || history.includes("farming") || history.includes("attacks") || history.includes("crafting") || history.includes("defence") || history.includes("construction") || history.includes("firemaking") || history.includes("fishing") || history.includes("fletching") || history.includes("herblore") || history.includes("hunter") || history.includes("magic") || history.includes("mining") || history.includes("runecrafting") || history.includes("smithing") || history.includes("strength") || history.includes("thieving") || history.includes("woodcutting") || history.includes(" black knight's fortress ") ||
            history.includes("cook's assistant") || history.includes("corsair curse") || history.includes("demon slayer") || history.includes("doric's quest") || history.includes("dragon slayer") || history.includes("ernest the chicken") || history.includes("goblin diplomacy") || history.includes("imp catcher") || history.includes("knight's sword") || history.includes("misthalin mystery") || history.includes("pirate's treasure") || history.includes("prince ali rescue") || history.includes("restless ghost") ||
            history.includes("romeo & juliet") || history.includes("rune mysteries") || history.includes("below ice mountain") || history.includes("sheep shearer") || history.includes("shield of arrav") || history.includes("vampyre slayer") || history.includes("witch's potion") || history.includes("x marks the spot") || history.includes("animal magnetism") || history.includes("another slice of ham") || history.includes("ascent of arceuus") || history.includes("between a rock") || history.includes("big chompy bird hunting") || history.includes("biohazard") || history.includes("bone voyage") || history.includes("cabin fever") || history.includes("client of kourend") || history.includes("clock tower") || history.includes("cold war") || history.includes("contact") || history.includes("creature of fenkenstrain") || history.includes("darkness of hallowvale") ||
            history.includes("death plateau") || history.includes("death to the dorgeshuun") || history.includes("depths of despair") || history.includes("desert treasure") || history.includes("devious minds") || history.includes("dig site") || history.includes("dragon slayer 2") || history.includes("dream mentor") || history.includes("druidic ritual") || history.includes("dwarf cannon") || history.includes("eadgar's ruse") || history.includes("eagles' peak") || history.includes("elemental workshop i") || history.includes("elemental workshop ii") || history.includes("enakhra's lament") || history.includes("enlightened journey") || history.includes("eyes of glouphrie") || history.includes("fairytale i - growing pains") || history.includes("fairytale ii - cure a queen") || history.includes("family crest") || history.includes("porcine of interest") || history.includes("feud") || history.includes("fight arena") || history.includes("fishing contest") || history.includes("forgettable tale") || history.includes("forsaken tower") || history.includes("fremennik exiles") || history.includes("fremennik isles") || history.includes("fremennik trials") || history.includes("garden of tranquillity") || history.includes("gertrude's cat") || history.includes("ghosts ahoy") || history.includes("giant dwarf") || history.includes("grand tree") || history.includes("great brain robbery") || history.includes("grim tales") || history.includes("hand in the sand") || history.includes("haunted mine") || history.includes("mage arena II") || history.includes("mage arena") || history.includes("hazeel cult") || history.includes("heroes' quest") || history.includes("holy grail") || history.includes("horror from the deep") || history.includes("icthlarin's little helper") || history.includes("in aid of the myreque") || history.includes("in search of the myreque") || history.includes("jungle potion") || history.includes("king's ransom") || history.includes("kingdom divided") || history.includes("legends' quest") || history.includes("lost city") || history.includes("lost tribe") || history.includes("lunar diplomacy") || history.includes("making friends with my arm") || history.includes("making history") || history.includes("merlin's crystal") || history.includes("monk's friend") || history.includes("monkey madness i") || history.includes("monkey madness ii") || history.includes("mountain daughter") || history.includes("mournings' end part i") || history.includes("mourning's end part ii") ||
            history.includes("murder mystery") || history.includes("my arm's big adventure") || history.includes("nature spirit") || history.includes("observatory quest") || history.includes("olaf's quest") || history.includes("one small favour") || history.includes("plague city") || history.includes("priest in peril") || history.includes("rag and bone man") || history.includes("rag and bone man ii") || history.includes("ratcatchers") || history.includes("recruitment drive") || history.includes("regicide") || history.includes("roving elves") || history.includes("royal trouble") || history.includes("rum deal") || history.includes("scorpion catcher") || history.includes("sea slug") || history.includes("shades of mort'ton") || history.includes("shadow of the storm") || history.includes("sheep herder") || history.includes("shilo village") || history.includes("sins of the father") || history.includes("song of the elves") || history.includes("a soul's bane") || history.includes("spirits of the elid") || history.includes("swan song") || history.includes("a taste of hope") || history.includes("tai bwo wannai trio") || history.includes("a tail of two cats") || history.includes("tale of the righteous") || history.includes("tears of guthix") || history.includes("temple of ikov") || history.includes("golem") || history.includes("queen of thieves") || history.includes("slug menace") || history.includes("tourist trap") || history.includes("throne of miscellania") || history.includes("tower of life") || history.includes("tree gnome village") || history.includes("tribal totem") || history.includes("troll romance") || history.includes("troll stronghold") || history.includes("underground pass") || history.includes("wanted!") || history.includes("watchtower") || history.includes("waterfall quest") || history.includes("what lies below") || history.includes("witch's house") || history.includes("zogre flesh eaters") || history.includes("another cook's quest") || history.includes("defeating the culinaromancer") || history.includes("freeing evil dave") || history.includes("freeing king awowogei") || history.includes("freeing pirate pete") || history.includes("freeing sir amik varze") || history.includes("freeing skrach uglogwee") || history.includes("freeing the goblin generals") || history.includes("freeing the lumbridge guide") || history.includes("freeing the mountain dwarf") || history.includes("alfred grimhand's barcrawl") || history.includes("architectural alliance") ||
            history.includes("bear your soul") || history.includes("curse of the empty lord") || history.includes("enchanted key") || history.includes("enter the abyss") || history.includes("family pest") || history.includes("general's shadow") || history.includes("in search of knowledge") || history.includes("lair of tarn razorlor") || history.includes("skippy and the mogres") || history.includes("daddys home") || history.includes("getting ahead") || history.includes("all fired up") ||
            ...
            history.includes("tale of the muspah") || history.includes("diamond in the rough") || history.includes("temple at sennestien") || history.includes("whats mine is yours") || history.includes("missing my mummy") || history.includes("defender of varrock") || history.includes("stolen hearts") || history.includes("back to my roots") || history.includes("back to the freezer") || history.includes("blood runs deep") || history.includes("branches of darkmeyer") || history.includes("children of mah") || history.includes("chosen commander") || history.includes("clockwork syringe") || history.includes("crocodile tears") || history.includes("elemental workshop 3") || history.includes("elemental workshop 4") || history.includes("glorius memories") || history.includes("heart of stone") || history.includes("hero's welcome") || history.includes("hunt for red raktuber") || history.includes("kennith's concerns") || history.includes("land of goblins") || history.includes("legacy of seergaze") || history.includes("river of blood") || history.includes("lord of vampyrium") || history.includes("mighty fall") || history.includes("nomad's elegy") || history.includes("our man in the north") || history.includes("prisoner of glouphrie") || history.includes("salt in the wound") || history.includes("some like it cold") || history.includes("toktz-ket-dill") || history.includes("violet is blue") || history.includes("desperate times") || history.includes("violet is blue too") || history.includes("you are it") || history.includes("desperate measures") || history.includes("in pyre need") || history.includes("call of the ancestors") || history.includes("chef's assistant") || history.includes("deadliest catch") || history.includes("do no evil") || history.includes("evil dave's big day out") || history.includes("gower quest") ||
            history.includes("kindred spirits") || history.includes("nomad's requiem") || history.includes("once upon a slime") ||
            history.includes("needle skips") || history.includes("bringing home the bacon") || history.includes("benedict's world tour") || history.includes("boric's task i") || history.includes("boric's task ii") || history.includes("boric's task iii") ||
            history.includes("curse of zaros") || history.includes("damage control") || history.includes("desert slayer dungeon") ||
            history.includes("doric's task i") || history.includes("doric's task ii") || history.includes("doric's task iii") || history.includes("doric's task iv") || history.includes("doric's task v") || history.includes("doric's task vi") || history.includes("doric's task vii") || history.includes("doric's task viii") || history.includes("eye for an eye") || history.includes("father and son") || history.includes("final destination") || history.includes("flag fall") || history.includes("flashback") || history.includes("foreshadowing") || history.includes("fortunes") || history.includes("from tiny acorns") ||
            history.includes("ghosts from the past") || history.includes("a guild of our own") || history.includes("harbinger") ||
            history.includes("head of the family") || history.includes("helping laniakea") || history.includes("hopespear's will") ||
            history.includes("hunt for surok") || history.includes("in memory of the myreque") || history.includes("koschei's troubles") || history.includes("lost her marbles") || history.includes("lost toys") || history.includes("mahjarrat memories") || history.includes("nadir") || history.includes("one foot in the grave") || history.includes("raksha, the shadow colossus") || history.includes("rebuilding edgeville") || history.includes("purple cat") || history.includes("spiritual enlightenment") || history.includes("sins of the father (miniquest)") || history.includes("tales of nomad") || history.includes("tales of the god wars") || history.includes("thok it to 'em") || history.includes("thok your block off") ||
            history.includes("three's company") || history.includes("tortle combat") || history.includes("tuai leit's own") ||
            history.includes("vengeance") ||
            history.includes("wandering ga'al") || history.includes("jed hunter") || history.includes("as a first resort") || history.includes("azzanadra's quest") || history.includes("beneath cursed tides") || history.includes("blood pact") || history.includes("branches of darkmeyer") || history.includes("brink of extinction") || history.includes("broken home") || history.includes("buyers and cellars") || history.includes("city of senntisten") || history.includes("dealing with scabaras") || history.includes("death of chivalry") || history.includes("dishonour among thieves") || history.includes("elder kiln") || history.includes("elemental workshop III") || history.includes("elemental workshop IV") || history.includes("fairytale iii - battle at ork's rift") || history.includes("firemaker's curse") || history.includes("forgiveness of a chaos dwarf") || history.includes("glorious memories") || history.includes("gunnar's ground") || history.includes("heartstealer") || history.includes("hunt for the red raktuber") || history.includes("impressing the locals") || history.includes("jack of spades") || history.includes("king of the dwarves") || history.includes("land of the goblins") || history.includes("let them eat pie") || history.includes("light within") || history.includes("love story") || history.includes("meeting history") || history.includes("missing presumed death") || history.includes("myths of the white land") || history.includes("one of a kind") || history.includes("one piercing note") || history.includes("path of glouphrie") || history.includes("perils of ice mountain") || history.includes("phite club") || history.includes("pieces of hate") || history.includes("plagues end") || history.includes("prisoner of glouphrie") || history.includes("quiet before the swarm") || history.includes("ritual of the mahjarrat") || history.includes("rocking out") || history.includes("rune mechanics") || history.includes("rune memories") || history.includes("shadow over ashdale") || history.includes("sliskes endgame") || history.includes("song from the depths") || history.includes("spirit of summer") || history.includes("summers end") || history.includes("swept away") || history.includes("temple of senntisten") || history.includes("void dance") || history.includes("void stares back") || history.includes("what's mine is yours") || history.includes("while guthix sleeps") || history.includes("within the light") || history.includes("wolf whistle") ||
